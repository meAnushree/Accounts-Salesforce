...
String xpath = ((findTestObject('SFDC/Profiles/AllProfilesName').findPropertyValue('xpath') + '//span[text()=\'') + profileList) + '\']'
	...
	WebUI.click(findTestObject('SFDC/Navigation/LogInUser'))
	}